(function ($, _) { // wrap in anonymous function to not show some helper variables
  ...
  LineBasedGrader.prototype.grade = function (elementId, builtFunc, testCases) {
    // if (this.evaluator !== null) {
    //   this.evaluator(builtFunc, testCases);
    // }
    var parson = this.parson;
    ...
    return { errors: errors, log_errors: log_errors, success: (errors.length === 0), code: code };
  };
  ...
  var ParsonsWidget = function (options) {
    ...
    //   this.grader.evaluator = options.evaluator;
    // } else {
    //   this.grader.evaluator = null;
    // }
  };
